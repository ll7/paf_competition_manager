...
import rospy
from paf_competition_manager.srv import SavePosition
...
def handle_save_position(req):
    ...
    if req.save:
        ...
        print('rosparam dump ~/carla-ros-bridge/paf/paf_competition_manager/config/TownXY/PositionXY.yaml '+ prefix)
        return True
    else:
