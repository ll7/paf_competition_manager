...
import paf_competition_manager.msg

class compete_action(object):
    _feedback = paf_competition_manager.msg.CompeteFeedback
    _result = paf_competition_manager.msg.CompeteResult

    def __init__(self, name):
        self._action_name = name
        self._as = actionlib.SimpleActionServer(
            self._action_name, 
            paf_competition_manager.CompeteAction, 
